            ...
            <form>
                ...
                {!login && <div className="row mb-3">
                    ...
                    <div className="col-sm-10">
                        <input type="text" onBlur={handleNameChange} className="form-control" id="inputName" placeholder="Please enter your name" required />
                    </div>
                </div>}
                <div className="row mb-3">
                    <label htmlFor="inputEmail3" className="col-sm-2 col-form-label">Email</label>
                    <div className="col-sm-10">
                        <input onBlur={changeEmailInput} type="email" className="form-control" id="inputEmail3" placeholder="Please enter your email" required />
                    </div>
                </div>
                <div className="row mb-3">
                    <label htmlFor="inputPassword3" className="col-sm-2 col-form-label">Password</label>
                    <div className="col-sm-10">
                        <input onBlur={changePasswordInput} type="password" className="form-control" id="inputPassword3" placeholder="Please enter your password" required />
                    </div>
                </div>
